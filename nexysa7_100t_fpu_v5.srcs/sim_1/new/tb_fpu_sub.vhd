...
--------------------------------------------------------------------------------
--                    TestBench_tb_top_fpu_sub_comb_uid28
-- This operator is part of the Infinite Virtual Library FloPoCoLib
-- All rights reserved 
...
entity TestBench_tb_top_fpu_sub_comb_uid28 is
end entity;

architecture behavorial of TestBench_tb_top_fpu_sub_comb_uid28 is
   component tb_top_fpu_sub is
      port ( X : in  std_logic_vector(5+10+2 downto 0);
             Y : in  std_logic_vector(5+10+2 downto 0);
             R : out  std_logic_vector(5+10+2 downto 0)   );
   end component;
...
begin
   ...
   begin
      ...
      assert false or fp_equal(R,fp18'("010100000000000000")) report "Incorrect output value for R, expected 010100000000000000 | Test Number : 0  " severity ERROR; 
      wait for 10 ns;
      -- current time: 22
      -- input: X <= "010011110000000000"; 
      ...
      assert false or fp_equal(R,fp18'("100000000000000000")) report "Incorrect output value for R, expected 100000000000000000 | Test Number : 3  " severity ERROR; 
      wait for 10 ns;
      -- current time: 52
      ...
      assert false or fp_equal(R,fp18'("011101010101111000")) report "Incorrect output value for R, expected 011101010101111000 | Test Number : 6  " severity ERROR; 
      wait for 10 ns;
      -- current time: 82
      -- input: X <= "010011110000000000"; 
      -- input: Y <= "011000111000000000"; 
      assert false or fp_equal(R,fp18'("010011110000000000")) report "Incorrect output value for R, expected 010011110000000000 | Test Number : 7  " severity ERROR; 
      wait for 10 ns;
      -- current time: 92
      -- input: X <= "010001010010000111"; 
      -- input: Y <= "011001010101010011"; 
      assert false or fp_equal(R,fp18'("010001100011101101")) report "Incorrect output value for R, expected 010001100011101101 | Test Number : 8  " severity ERROR; 
      wait for 10 ns;
      -- current time: 102
      -- input: X <= "011111111110110110"; 
      -- input: Y <= "010111101100111111"; 
      assert false or fp_equal(R,fp18'("101000000000000000")) report "Incorrect output value for R, expected 101000000000000000 | Test Number : 9  " severity ERROR; 
      wait for 10 ns;
      -- current time: 112
      -- input: X <= "011000000111110001"; 
      -- input: Y <= "010000010001101101"; 
      assert false or fp_equal(R,fp18'("011000011101100110")) report "Incorrect output value for R, expected 011000011101100110 | Test Number : 10  " severity ERROR; 
      wait for 10 ns;
      -- current time: 122
      ...
      assert false or fp_equal(R,fp18'("011110010000001111")) report "Incorrect output value for R, expected 011110010000001111 | Test Number : 12  " severity ERROR; 
      wait for 10 ns;
      -- current time: 142
      -- input: X <= "010010011000111000"; 
      -- input: Y <= "010011000110001001"; 
      assert false or fp_equal(R,fp18'("011011000011000010")) report "Incorrect output value for R, expected 011011000011000010 | Test Number : 13  " severity ERROR; 
      wait for 10 ns;
      -- current time: 152
      -- input: X <= "010101010001011101"; 
      -- input: Y <= "010110101110100110"; 
      assert false or fp_equal(R,fp18'("011110101110000011")) report "Incorrect output value for R, expected 011110101110000011 | Test Number : 14  " severity ERROR; 
      wait for 10 ns;
      -- current time: 162
      ...
      assert false or fp_equal(R,fp18'("011011110111100010")) report "Incorrect output value for R, expected 011011110111100010 | Test Number : 16  " severity ERROR; 
      wait for 10 ns;
      -- current time: 182
      -- input: X <= "011101111000100000"; 
      -- input: Y <= "010101101111011100"; 
      assert false or fp_equal(R,fp18'("011110000100000111")) report "Incorrect output value for R, expected 011110000100000111 | Test Number : 17  " severity ERROR; 
      wait for 10 ns;
      -- current time: 192
      -- input: X <= "011000000100000110"; 
      -- input: Y <= "011111111000001011"; 
      assert false or fp_equal(R,fp18'("010111111000001011")) report "Incorrect output value for R, expected 010111111000001011 | Test Number : 18  " severity ERROR; 
      wait for 10 ns;
      -- current time: 202
      ...
      assert false or fp_equal(R,fp18'("010000010000101100")) report "Incorrect output value for R, expected 010000010000101100 | Test Number : 22  " severity ERROR; 
      wait for 10 ns;
      -- current time: 242
      ...
      assert false or fp_equal(R,fp18'("011011010000111010")) report "Incorrect output value for R, expected 011011010000111010 | Test Number : 24  " severity ERROR; 
      wait for 10 ns;
      -- current time: 262
      -- input: X <= "010000000101100010"; 
      -- input: Y <= "011000010001001011"; 
      assert false or fp_equal(R,fp18'("010000011011111100")) report "Incorrect output value for R, expected 010000011011111100 | Test Number : 25  " severity ERROR; 
      wait for 10 ns;
      -- current time: 272
      -- input: X <= "010010010110111011"; 
      -- input: Y <= "011010001001011010"; 
      assert false or fp_equal(R,fp18'("010010100001110100")) report "Incorrect output value for R, expected 010010100001110100 | Test Number : 26  " severity ERROR; 
      wait for 10 ns;
      -- current time: 282
